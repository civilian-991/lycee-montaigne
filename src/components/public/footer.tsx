        ...
        <div className="grid gap-8 md:grid-cols-3">
          ...
          <div>
            ...
            <div className="mt-6 flex gap-3">
              <a href="https://www.facebook.com/LyceeMontaigneBeitChabab" target="_blank" rel="noopener noreferrer" aria-label="Facebook" className="rounded-full bg-white/10 p-2 transition-colors hover:bg-white/20">
              ...
              <a href="https://www.linkedin.com/school/lyc%C3%A9e-montaigne-beit-chabab/" target="_blank" rel="noopener noreferrer" aria-label="LinkedIn" className="rounded-full bg-white/10 p-2 transition-colors hover:bg-white/20">
              ...
              <a href="https://www.instagram.com/lyceemontaignebeitchabab/" target="_blank" rel="noopener noreferrer" aria-label="Instagram" className="rounded-full bg-white/10 p-2 transition-colors hover:bg-white/20">
