...
export function Navbar() {
  ...
  return (
    <header className="sticky top-0 z-50 bg-white shadow-sm">
      ...
      <div className={cn(
        "overflow-hidden border-b border-border/50 transition-all duration-300",
        scrolled ? "max-h-0 border-none" : "max-h-28"
      )}>
        <div className="mx-auto flex max-w-7xl items-center justify-between px-4 py-3">
          ...
          <div className="hidden items-center gap-4 lg:flex">
            ...
            <Image
              ...
              alt="Homologation du ministère français"
              width={120}
              height={48}
              className="h-10 w-auto"
            />
      ...
      <div className={cn(
        "overflow-hidden border-b border-border/50 transition-all duration-300",
        scrolled ? "max-h-0 border-none" : "max-h-16"
      )}>
        <div className="mx-auto flex max-w-7xl items-center justify-between px-4 py-2">
          ...
          <div className="hidden items-center gap-2 md:flex">
            <a href="https://www.facebook.com/LyceeMontaigneBeitChabab" target="_blank" rel="noopener noreferrer" aria-label="Facebook" className="flex h-9 w-9 items-center justify-center rounded-full border-2 border-primary text-primary transition-colors hover:bg-primary hover:text-white">
            ...
            <a href="https://www.linkedin.com/school/lyc%C3%A9e-montaigne-beit-chabab/" target="_blank" rel="noopener noreferrer" aria-label="LinkedIn" className="flex h-9 w-9 items-center justify-center rounded-full border-2 border-primary text-primary transition-colors hover:bg-primary hover:text-white">
            ...
            <a href="https://www.instagram.com/lyceemontaignebeitchabab/" target="_blank" rel="noopener noreferrer" aria-label="Instagram" className="flex h-9 w-9 items-center justify-center rounded-full border-2 border-primary text-primary transition-colors hover:bg-primary hover:text-white">
          ...
          <div className="hidden items-center gap-2 lg:flex">
            <a
              ...
              className="rounded-full border-2 border-primary px-5 py-1.5 text-sm font-semibold uppercase tracking-wide text-primary transition-colors hover:bg-primary hover:text-white"
            >
              Pronote
            </a>
            <Link
            ...
            <Link
              href="/anciens"
              className="rounded-full border-2 border-primary bg-primary px-5 py-1.5 text-sm font-semibold uppercase tracking-wide text-white transition-colors hover:bg-primary-light"
            >
              Anciens élèves
            </Link>
          </div>
          ...
          <div className="flex items-center gap-2 lg:hidden">
            <button
              className="rounded-md p-2 text-text-muted transition-colors hover:bg-background-alt md:hidden"
            ...
            <button
              className="rounded-md p-2 text-text-muted transition-colors hover:bg-background-alt"
          ...
          <div className="border-t border-border/50 px-4 py-2 md:hidden">
            <div className="relative">
              ...
              <input
                ...
                placeholder="Rechercher..."
                autoFocus
                className="h-9 w-full rounded-full border border-border bg-background-alt pl-9 pr-4 text-sm text-text outline-none focus:border-primary"
              />
            </div>
          </div>
        )}
        ...
        <div className="mx-auto max-w-7xl px-4">
          <div className="flex h-12 items-center justify-between">
            ...
            <Link href="/" className={cn(
              ...
              scrolled ? "mr-4 w-auto opacity-100" : "mr-0 w-0 overflow-hidden opacity-0"
            )}>
              <Image
                src="/images/logo.png"
                alt="Lycée Montaigne"
                    ...
                    <div className="absolute left-0 top-full z-50 min-w-56 rounded-lg border border-border bg-white py-1.5 shadow-xl">
                      {item.children.map((child) => (
                        <Link
                          key={child.href}
                          href={child.href}
                          className="block px-4 py-2 text-sm text-text-muted transition-colors hover:bg-primary/5 hover:text-primary"
                        >
                          {child.label}
                        </Link>
                      ))}
            ...
            <button
              className="rounded-md p-2 text-text-muted transition-colors hover:bg-background-alt lg:hidden"
              onClick={() => setMobileOpen(true)}
              aria-label="Ouvrir le menu"
            >
              <Menu className="h-6 w-6" />
        ...
        <nav className="overflow-y-auto p-4" style={{ maxHeight: "calc(100vh - 65px)" }}>
          ...
          <div className="relative mb-4">
            ...
            <input
              type="text"
              placeholder="Rechercher..."
              className="h-10 w-full rounded-full border border-border bg-background-alt pl-9 pr-4 text-sm text-text outline-none focus:border-primary"
            />
          </div>
          ...
          <div className="mt-4 space-y-2">
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="flex items-center justify-center gap-2 rounded-full border-2 border-primary px-4 py-2.5 text-sm font-semibold uppercase text-primary"
            >
